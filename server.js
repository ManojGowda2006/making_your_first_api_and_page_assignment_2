...
//   switch(code){
//     case 200: return `OK: The request has succeeded. The meaning of this status depends on the HTTP method used.`;
//     case 404: return `Not Found: The server has not found anything matching the request URI. This is often caused by a missing page or resource.`;
//     case 500: return `Internal Server Error: The server encountered an unexpected condition that prevented it from fulfilling`;
//     case 400: return `Bad Request: The server cannot process the request due to client-sid`;
//   }
// }
